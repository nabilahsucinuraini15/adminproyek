                                    ...
                                    <table class="table select-table">
                                      ...
                                      <tbody>
                                        <tr>
                                          ...
                                          <td>
                                            <div class="d-flex ">
                                              <img src="src/assets/images/faces/face1.jpg" alt="">
                                              <div>
                                        ...
                                        <tr>
                                          ...
                                          <td>
                                            <div class="d-flex">
                                              <img src="src/assets/images/faces/face4.jpg" alt="">
                                              <div>
                                        ...
                                        <tr>
                                          ...
                                          <td>
                                            <div class="d-flex">
                                              <img src="src/assets/images/faces/face5.jpg" alt="">
                                              <div>
                                    ...
                                    <div class="col-lg-12">
                                      ...
                                      <div class="mt-3">
                                        <div class="wrapper d-flex align-items-center justify-content-between py-2 border-bottom">
                                          <div class="d-flex">
                                            <img class="img-sm rounded-10" src="src/assets/images/faces/face1.jpg" alt="profile">
                                        ...
                                        <div class="wrapper d-flex align-items-center justify-content-between py-2 border-bottom">
                                          <div class="d-flex">
                                            <img class="img-sm rounded-10" src="src/assets/images/faces/face2.jpg" alt="profile">
                                            <div class="wrapper ms-3">
                                        ...
                                        <div class="wrapper d-flex align-items-center justify-content-between py-2 border-bottom">
                                          <div class="d-flex">
                                            <img class="img-sm rounded-10" src="src/assets/images/faces/face3.jpg" alt="profile">
                                            <div class="wrapper ms-3">
                                        ...
                                        <div class="wrapper d-flex align-items-center justify-content-between py-2 border-bottom">
                                          <div class="d-flex">
                                            <img class="img-sm rounded-10" src="src/assets/images/faces/face4.jpg" alt="profile">
                                            <div class="wrapper ms-3">
                                        ...
                                        <div class="wrapper d-flex align-items-center justify-content-between pt-2">
                                          <div class="d-flex">
                                            <img class="img-sm rounded-10" src="src/assets/images/faces/face5.jpg" alt="profile">
                                            <div class="wrapper ms-3">
